...
int main() { 
    ...
    double x = 50.0,total = 50.0,price = 100.0,discount = 20.0,rate = 10.0,score = 10.0,penalty = 10.0; // กำหนดค่าเริ่มต้นสำหรับตัวแปรต่างๆ 
    int y = 20,z = 10,a = 15,quantity = 5,mistake = 10;                               // กำหนดค่าเริ่มต้นสำหรับตัวแปรต่างๆ 
    ...
    full1 = full1 - 4.0;
    printf("   แบบเต็ม x = x - 4.0; x = %.1f\n", full1);  // แสดงผลลัพธ์แบบเต็ม
    short1 -= 4.0;
    printf("   แบบย่อ  x -= 4.0;    x = %.1f\n", short1); // แสดงผลลัพธ์แบบย่อ

    if (full1 == short1) {
        printf("   ผลลัพธ์: True\n");  // แสดงผลลัพธ์ถ้าค่าเป็นจริง
    } else {
        printf("   ผลลัพธ์: False\n"); // แสดงผลลัพธ์ถ้าค่าไม่เป็นจริง
    }
    ...
    double short2 = x;
    full2 = 6.5 * full2;
    printf("   แบบเต็ม x = 6.5 * x;  x = %.1f\n", full2); // แสดงผลลัพธ์แบบเต็ม
    short2 *= 6.5; // หรือ x *= 6.5;
    printf("   แบบย่อ  x *= 6.5;     x = %.1f\n", short2); // แสดงผลลัพธ์แบบย่อ
    ...
    if (divisor4 == 0) {
        ...
        printf("   แบบเต็ม x = x / (2.0 * x);  x = %.1f\n", full4);//  แสดงผลลัพธ์แบบเต็ม
        short4 /= divisor4; // หรือ x /= (2.0 * x);
        printf("   แบบย่อ  x /= (2.0 * x);     x = %.1f\n", short4);//  แสดงผลลัพธ์แบบย่อ
        if (full4 == short4) {
            printf("   ผลลัพธ์: True\n");// แสดงผลลัพธ์ถ้าค่าเป็นจริง
        } else {
            printf("   ผลลัพธ์: False\n"); // แสดงผลลัพธ์ถ้าค่าไม่เป็นจริง
    ...
    printf("   แบบเต็ม total = total + (price * quantity - discount); total = %.1f\n", totalfull5);//  แสดงผลลัพธ์แบบเต็ม
    totalshort5 += valuetoadd5;
    printf("   แบบย่อ  total += (price * quantity - discount);        total = %.1f\n", totalshort5);//  แสดงผลลัพธ์แบบย่อ
    ...
    full6 = full6 * factor6;
    printf("   แบบเต็ม x = x *(1 + rate / 100);  x = %.1f\n", full6);//  แสดงผลลัพธ์แบบเต็ม
    short6 *= factor6;
    printf("   แบบย่อ  x *= (1 + rate / 100);    x = %.1f\n", short6);//  แสดงผลลัพธ์แบบย่อ
    if (full6 == short6) {
        printf("   ผลลัพธ์: True\n");// แสดงผลลัพธ์ถ้าค่าเป็นจริง
    } else {
        printf("   ผลลัพธ์: False\n"); // แสดงผลลัพธ์ถ้าค่าไม่เป็นจริง
    ...
    printf("   แบบเต็ม score = score - (penalty * (mistake + 1));   score = %.1f\n", scorefull7);//  แสดงผลลัพธ์แบบเต็ม
    scoreshort7 -= deduction7;
    printf("   แบบย่อ  score -= (penalty * (mistake + 1));          score = %.1f\n", scoreshort7);//  แสดงผลลัพธ์แบบย่อ
